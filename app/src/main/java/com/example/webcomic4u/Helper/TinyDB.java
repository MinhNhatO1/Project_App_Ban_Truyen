...
public class TinyDB {
    ...
    public ArrayList<MangaDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<MangaDomain> playerList =  new ArrayList<MangaDomain>();

        for(String jObjString : objStrings){
            MangaDomain player  = gson.fromJson(jObjString,  MangaDomain.class);
    ...
    public void putListObject(String key, ArrayList<MangaDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(MangaDomain player: playerList){
